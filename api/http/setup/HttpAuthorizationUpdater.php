...
use Symsonte\Http\Server\Request\Authorization\Resource\Loader;
 ...
 */
class HttpAuthorizationUpdater implements Updater
{
    /**
     * @var Loader
     */
     ...
     *
     * @ds\arguments({
     *     loader: "@symsonte.http.server.request.authorization.resource.loader"
     * })
     */
    ...
    {
        if (!$declaration->is('symsonte.http.server.request.authorization.checker')) {
            return $declaration;
        }
